...
func TestStoreDeclaresCompleteServiceSchema(t *testing.T) {
	...
	wantColumns := map[string][]string{
		"jobs":                      {"image_resolution_json", "image_resolution_hash", "prestart_budget_deadline_ns", "prestart_terminal_reason", "completion_replay_attempt_id"},
		...
		"service_removals": {
			...
			"requested_ns", "cleanup_acknowledgement_key", "cleanup_acknowledgement_hash", "cleanup_quarantine_json", "agent_cleaned_ns", "removed_ns",
		},
		"service_tombstones": {
