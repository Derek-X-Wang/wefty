...
func (c *Client) AcknowledgeComputerReimagePreflight(ctx context.Context, computerID string, request l1.ComputerReimagePreflightAcknowledgementRequest) (l1.Computer, error) {
	var computer l1.Computer
	err := c.post(ctx, "/v1/agent/computers/"+url.PathEscape(computerID)+"/reimage-preflight-acknowledgement", request, &computer)
	return computer, err
}
...
func (c *Client) AcknowledgeComputerStorageCopy(ctx context.Context, computerID string, request l1.ComputerStorageCopyAcknowledgementRequest) (l1.Computer, error) {
	var computer l1.Computer
	err := c.post(ctx, "/v1/agent/computers/"+url.PathEscape(computerID)+"/storage-copy-acknowledgement", request, &computer)
	return computer, err
}
