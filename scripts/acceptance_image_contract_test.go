...
func TestAcceptanceImageWorkflowContract(t *testing.T) {
	...
	assertFileContains(t, "../examples/computer-wayland/sway-config", `title="^Wefty Wayland Computer$"`, "border none", "fullscreen enable", `app_id="wev"] border none`, "opacity set 0.0", "floating enable", "resize set width 1280 px height 720 px", "focus")
